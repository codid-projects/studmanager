...
export const PerformanceModals = ({
  isOpen,
  type,
  onClose,
  ...
  const t = (lang === "ar" ? arTranslations : enTranslations).performanceModals;
      ...
      <div className="relative my-3 flex max-h-[calc(100dvh-1.5rem)] w-full max-w-4xl flex-col overflow-hidden rounded-[28px] bg-white font-cairo shadow-xl sm:my-8 sm:max-h-[calc(100dvh-4rem)] sm:rounded-3xl">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-4 sm:gap-y-6 md:grid-cols-2">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={type === "edit" ? "07/4/2025" : t.trainingDate}
              defaultValue={type === "edit" ? "07/4/2025" : ""}
          ...
          <div className="relative">
            ...
            <select
              ...
              dir={direction}
            >
              <option disabled selected>{t.trainerName}</option>
              <option>{t.muhammadAhmed}</option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              dir={direction}
            >
              <option disabled selected>{t.trainingType}</option>
              <option>{t.fitnessTraining}</option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              dir={direction}
            >
              <option disabled selected>{t.trainingDuration}</option>
              <option>{t.hour}</option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={type === "edit" ? "07/4/2026" : t.notifyMe}
              defaultValue={type === "edit" ? "07/4/2026" : ""}
              className={`w-full rounded-xl border border-gray-300 bg-white py-3.5 text-gray-700 outline-none placeholder-gray-400 focus:border-[#4b2f1a] sm:py-4 ${isRTL ? "pr-12 pl-4 text-right" : "pl-12 pr-4 text-left"}`}
            />
          </div>
